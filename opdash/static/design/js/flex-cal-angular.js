angular
    ...
    .controller('MainController', ['$scope', function($scope) {
        ...
        $scope.events = [
            { foo: 'bar', date: "2017-08-18" },
            { foo: 'bar', date: "2017-08-20" }
        ];
    }])
...
! function() { "use strict";
    ...
    function t(e, t) {
        function a() { e.mappedDisabledDates = e.options.disabledDates.map(function(e) {
                return new Date(e) }) }

        function n() { e.mappedEvents = e.events.map(function(e) {
